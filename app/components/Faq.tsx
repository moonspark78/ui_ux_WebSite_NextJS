...
const Faq = () => {
  return (
    <div className="flex flex-col w-full py-[48px] lg:py-[60px] lg:flex-row lg:gap-x-6">
      <div className="lg:w-1/3 lg:py-[32px] lg:pr-[32px]">
        <h3 className="font-medium text-[#EB2891] text-[14px] lg:text-base">
          Frequently Asked Questions
        </h3>
        <h1 className="font-medium text-[#172026] text-[24px] py-[16px] lg:text-[42px] lg:leading-[58px]">
              ...
              >
                <Accordion.Header>
                  <Accordion.Trigger className="flex w-full items-center justify-between">
                    <p className="text-left font-medium text-[#172026] text-[16px]">
                      {item.question}
                    </p>
                    <span>
                      <Image src={Plus} alt="see" className="h-10 w-10" />
                    </span>
                  </Accordion.Trigger>
                </Accordion.Header>
                <Accordion.Content>
